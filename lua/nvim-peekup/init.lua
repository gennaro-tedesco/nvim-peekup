...
sets the corresponding buffer options and commands on keystroke ]] local peekup =
...
local function peekup_open(paste_where)
    ...
    if vim.bo.filetype == "peek" then return nil end
    ...
    if paste_where == nil then paste_where = '' end
